...
The described algorithm yield an optimal solution, and the
upper bound cost is quite manageable at $o(O \cdot E \cdot log(E))$
where $O$ is the number of objectives in the list and $E$ is the
